...
namespace GuniApp.Web.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,EnrollmentID,ProjectDescription,document,Startdate,Enddate,Comment,FacultyName")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("UserId,EnrollmentID,ProjectDescription,document,Startdate,Enddate,Comment,FacultyName")] Student student)
        {
